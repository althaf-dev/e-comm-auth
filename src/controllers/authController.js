...
async function signup(req, res,next) {
    try {
        ...
        console.log("without raw",req.body)
        ...
        const data = await User.createUser({ username, password });
...
async function login(req, res, next) {
    try {
        ...
        handleLoginSuccess(req, res, accessToken, user, redirectTo);
    } catch (e) {
...
function profileImage(req,res,next){
    res.status(200).send({imageUrl:"http://localhost:8000/public/profiles/1741048192309.jpg"})
}
